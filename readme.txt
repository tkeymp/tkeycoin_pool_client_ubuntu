...
Добавим, что клиент вполне может заработать и в других debian-подобных системах - пробуйте, экспериментриуйте)
...
Устанавливаем Tkeycoin Core. Актуальную версию кошелька можно найти на оффициальном сайте:
...
screen -dmS pool_client sudo ./pool_client IP:port ваш адрес
